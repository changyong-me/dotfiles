...
function Bootstrap {
  ...
  New-Link  "$Dotfiles\claude\skills\batch-grill-me" "$env:USERPROFILE\.claude\skills\batch-grill-me"
  New-Link  "$Dotfiles\claude\skills\code-review"    "$env:USERPROFILE\.claude\skills\code-review"
  New-Link  "$Dotfiles\claude\skills\to-spec"        "$env:USERPROFILE\.claude\skills\to-spec"
