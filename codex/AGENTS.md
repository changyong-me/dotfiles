...
- When aligning, discuss one point at a time and wait for the user's input before moving to the next.
- When researching, do not rely solely on official documentation; use community resources as well.
