...
Each subagent should inspect the issue, list available skills and read their descriptions, choose applicable skills, plan the fix, implement it, validate it, commit the changes, and report the result.
