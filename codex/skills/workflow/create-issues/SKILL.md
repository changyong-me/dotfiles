...
Mark an issue agent-ready when it can be completed without further human decisions; mark it human-in-the-loop when it needs user input, access, or external decisions.
